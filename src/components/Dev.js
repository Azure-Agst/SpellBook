      ...
      return (
        <div>
          ...
          <Container>
            ...
            <ul>
              <li>Spellbook v1.0.0 went live.</li>
              ...
              <li>Did some reverse engineering on the game's files, in hopes that Proletariat would start encrypting their game files. Also to grab a bunch of the assets for the encyclopedia part of this project. (Writeup located <a href="https://gist.github.com/Azure-Agst/6c21c9840e078b722290808077f8b40f">here</a>!)</li>
            </ul>
            ...
            <p>Till then, I hope you enjoy the basics, and <a href="https://goo.gl/forms/olPLfkCrO3sXVPQl1">do give feedback</a>! Happy spellcasting, all!</p>
          </Container>
          <br />
        </div>
      )
