...
export default class Footer extends React.Component {
  ...
  render() {
    return(
      <Container>
        <hr />
        <b style={styles.BoldFoot}>Copyright (c) 2018 Andrew "Azure" Augustine. <a href="https://www.paypal.me/AzureAugust" style={styles.DonateFoot}>Donate?</a> <a href="https://goo.gl/forms/olPLfkCrO3sXVPQl1" style={styles.DonateFoot}>Feedback?</a></b>
